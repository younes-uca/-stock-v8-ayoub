...
public class ProduitCriteria extends  BaseCriteria  {
    ...
    private String prixVenteMinMin;
    private String prixVenteMinMax;
    ...
    public String getPrixVenteMinMin(){
        return this.prixVenteMinMin;
    }
    public void setPrixVenteMinMin(String prixVenteMinMin){
        this.prixVenteMinMin = prixVenteMinMin;
    }
    public String getPrixVenteMinMax(){
        return this.prixVenteMinMax;
    }
    public void setPrixVenteMinMax(String prixVenteMinMax){
        this.prixVenteMinMax = prixVenteMinMax;
    }
