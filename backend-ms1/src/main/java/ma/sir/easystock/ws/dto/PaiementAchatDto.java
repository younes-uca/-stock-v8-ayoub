...
public class PaiementAchatDto  extends AuditBaseDto {
    ...
    private EtatPaiementAchatDto etatPaiementAchat ;
    ...
    public EtatPaiementAchatDto getEtatPaiementAchat(){
        return this.etatPaiementAchat;
    }

    public void setEtatPaiementAchat(EtatPaiementAchatDto etatPaiementAchat){
