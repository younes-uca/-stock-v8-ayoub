...
public class CommandeRestAdmin  extends AbstractController<Commande, CommandeDto, CommandeHistory, CommandeCriteria, CommandeHistoryCriteria, CommandeAdminService, CommandeConverter> {
    ...
    @ApiOperation("Finds an optimized list of all commandes")
    ...
    @ApiOperation("find by paiementCommande id")
    @GetMapping("paiementCommande/id/{id}")
    public List<Commande> findByPaiementCommandeId(@PathVariable Long id){
        return service.findByPaiementCommandeId(id);
    }
    @ApiOperation("delete by paiementCommande id")
    @DeleteMapping("paiementCommande/id/{id}")
    public int deleteByPaiementCommandeId(@PathVariable Long id){
        return service.deleteByPaiementCommandeId(id);
    }
