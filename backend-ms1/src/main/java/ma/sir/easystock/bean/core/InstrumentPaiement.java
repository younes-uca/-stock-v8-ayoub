...
public class InstrumentPaiement   extends AuditBusinessObject     {
    ...
    public InstrumentPaiement(){
        super();
    }

    public InstrumentPaiement(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        InstrumentPaiement instrumentPaiement = (InstrumentPaiement) o;
        return id != null && id.equals(instrumentPaiement.id);
    }
