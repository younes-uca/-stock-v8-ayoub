...
export class DevisFournisseurEditAdminComponent extends AbstractEditController<DevisFournisseurDto, DevisFournisseurCriteria, DevisFournisseurService>   implements OnInit {
    ...
    constructor( private devisFournisseurService: DevisFournisseurService , private produitService: ProduitService, private devisItemFournisseurService: DevisItemFournisseurService, private fournisseurService: FournisseurService) {
    ...
    public prepareEdit() {
        this.item.dateDevis = this.devisFournisseurService.format(this.item.dateDevis);
    }
