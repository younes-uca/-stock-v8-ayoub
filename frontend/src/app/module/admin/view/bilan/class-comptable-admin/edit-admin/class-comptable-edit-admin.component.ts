...
export class ClassComptableEditAdminComponent extends AbstractEditController<ClassComptableDto, ClassComptableCriteria, ClassComptableService>   implements OnInit {
    ...
    public validateSousClassComptables(){
   ...
   public addSousClassComptables() {
       ...
       if (this.errorMessages.length === 0) {
            if(this.sousClassComptablesElement.id == null){
                this.item.sousClassComptables.push(this.sousClassComptablesElement);
            }else{
                const index = this.item.sousClassComptables.findIndex(e => e.id == this.sousClassComptablesElement.id);
                this.item.sousClassComptables[index] = this.sousClassComptablesElement;
            }
    ...
    private validateSousClassComptablesLibelle(){
    ...
    private validateSousClassComptablesCode(){
