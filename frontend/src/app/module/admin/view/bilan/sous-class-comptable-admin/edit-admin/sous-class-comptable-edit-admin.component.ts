...
export class SousClassComptableEditAdminComponent extends AbstractEditController<SousClassComptableDto, SousClassComptableCriteria, SousClassComptableService>   implements OnInit {
    ...
    constructor( private sousClassComptableService: SousClassComptableService , private classComptableService: ClassComptableService, private compteComptableService: CompteComptableService) {
    ...
    public validateCompteComptables(){
   ...
   public addCompteComptables() {
       ...
       if (this.errorMessages.length === 0) {
            if(this.compteComptablesElement.id == null){
                this.item.compteComptables.push(this.compteComptablesElement);
            }else{
                const index = this.item.compteComptables.findIndex(e => e.id == this.compteComptablesElement.id);
                this.item.compteComptables[index] = this.compteComptablesElement;
            }
    ...
    private validateCompteComptablesLibelle(){
    ...
    private validateCompteComptablesCode(){
