...
export class ProduitCreateAdminComponent extends AbstractCreateController<ProduitDto, ProduitCriteria, ProduitService>  implements OnInit {
   ...
   private _validProduitLibelle = true;
    ...
    constructor( private produitService: ProduitService , private categorieProduitService: CategorieProduitService, private uniteMesureService: UniteMesureService, private stockProduitService: StockProduitService, private marqueService: MarqueService, private magasinService: MagasinService, private storeService: StoreService) {
