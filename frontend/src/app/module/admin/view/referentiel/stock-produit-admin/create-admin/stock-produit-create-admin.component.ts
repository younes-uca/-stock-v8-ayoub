...
@Component({
  selector: 'app-stock-produit-create-admin',
  templateUrl: './stock-produit-create-admin.component.html'
})
export class StockProduitCreateAdminComponent extends AbstractCreateController<StockProduitDto, StockProduitCriteria, StockProduitService>  implements OnInit {
    ...
    constructor( private stockProduitService: StockProduitService , private produitService: ProduitService, private magasinService: MagasinService) {
