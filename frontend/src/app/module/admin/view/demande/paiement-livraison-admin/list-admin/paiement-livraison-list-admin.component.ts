...
export class PaiementLivraisonListAdminComponent extends AbstractListController<PaiementLivraisonDto, PaiementLivraisonCriteria, PaiementLivraisonService>  implements OnInit {
    ...
    constructor(paiementLivraisonService: PaiementLivraisonService, private livraisonService: LivraisonService, private venteService: VenteService, private modePaiementService: ModePaiementService) {
