...
export class DemandeEditAdminComponent extends AbstractEditController<DemandeDto, DemandeCriteria, DemandeService>   implements OnInit {
    ...
    public validatePaiementDemandes(){
        this.errorMessages = new Array();
   ...
   public addPaiementDemandes() {
       ...
       if (this.errorMessages.length === 0) {
            if(this.paiementDemandesElement.id == null){
                this.item.paiementDemandes.push(this.paiementDemandesElement);
            }else{
                const index = this.item.paiementDemandes.findIndex(e => e.id == this.paiementDemandesElement.id);
                this.item.paiementDemandes[index] = this.paiementDemandesElement;
            }
    ...
    private validatePaiementDemandesReference(){
