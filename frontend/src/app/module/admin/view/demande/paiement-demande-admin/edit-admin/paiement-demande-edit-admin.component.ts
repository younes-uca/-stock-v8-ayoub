...
export class PaiementDemandeEditAdminComponent extends AbstractEditController<PaiementDemandeDto, PaiementDemandeCriteria, PaiementDemandeService>   implements OnInit {
    ...
    public prepareEdit() {
        ...
        this.item.dateEcheance = this.paiementDemandeService.format(this.item.dateEcheance);
        this.item.dateDepose = this.paiementDemandeService.format(this.item.dateDepose);
    }
