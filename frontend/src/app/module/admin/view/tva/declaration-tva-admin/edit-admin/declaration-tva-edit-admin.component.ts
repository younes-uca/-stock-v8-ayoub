...
export class DeclarationTvaEditAdminComponent extends AbstractEditController<DeclarationTvaDto, DeclarationTvaCriteria, DeclarationTvaService>   implements OnInit {
    ...
    constructor( private declarationTvaService: DeclarationTvaService , private societeService: SocieteService, private tauxRetardTvaService: TauxRetardTvaService, private comptableValidateurService: ComptableValidateurService, private comptableTraitantService: ComptableTraitantService) {
