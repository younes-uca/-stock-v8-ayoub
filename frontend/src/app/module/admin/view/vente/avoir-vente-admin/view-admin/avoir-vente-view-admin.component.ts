...
export class AvoirVenteViewAdminComponent extends AbstractViewController<AvoirVenteDto, AvoirVenteCriteria, AvoirVenteService> implements OnInit {
    ...
    constructor(private avoirVenteService: AvoirVenteService, private produitService: ProduitService, private avoirVenteItemService: AvoirVenteItemService, private venteService: VenteService){
